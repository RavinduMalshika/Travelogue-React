...
const DestinationCard = ({ title, cost, image, type, rating, description, location }) => {
    return (
        <div className='w-52 sm:w-64 md:w-80 xl:w-96 ms-3 my-3 p-5 rounded-xl bg-grgay-200 shadow hover:shadow-lg'>
            ...
            <div className="flex flex-col md:flex-row my-1">
                <p className="font-semibold text-red-600 my-1">{cost}</p>
